        ...
        <footer>
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="md:flex md:justify-between">
                    <div className="hidden md:inline-flex mb-6 md:mb-0">
                        <a href="https://tailwindui.com/" className="flex items-center">
                            <img src={images.logo} className="h-16 me-3" alt="FlowBite Logo" />
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 md:grid-cols-3">
                            ...
                            <div className="md:w-[214px]">
                                ...
                                <span className="text-gray-500 dark:text-gray-400 font-medium">
                                    Trường Đại học Khoa Học Tự Nhiên 227 Nguyễn Văn Cừ, phường 4, Quận 5, Thành phố Hồ
                                    Chí Minh
                                </span>
                            </div>
                        </div>
