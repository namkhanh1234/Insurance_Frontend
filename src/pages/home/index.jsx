    ...
    return (
        <div>
            ...
            <div className="py-10 mx-4">
                ...
                {/* Body */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 justify-between xl:mx-28">
                    {/* Item - box */}
            ...
            <div className={cx('wrapper')}>
                <h3 className="font-bold text-sky-600 ml-10 mb-4 text-xl md:text-4xl">NHỮNG THẾ MẠNH CỦA KNH CARE </h3>
                <div className="flex justify-evenly items-center">
                    <div className="flex flex-col justify-between space-y-6 lg:space-y-10 xl:space-y-14">
                        <div className="flex items-center">
                            <ShieldPlus className="mr-2 w-[3vw] h-auto" />
                            <p className="ml-3 md:text-lg lg:text-2xl  font-semibold">QUYỀN LỢI BẢO HIỂM TOÀN DIỆN</p>
                        </div>
                        <div className="flex items-center">
                            <Baby className="mr-2 w-[3vw] h-auto" />
                            <p className="ml-3 md:text-lg lg:text-2xl  font-semibold">TRẺ EM ĐƯỢC THAM GIA ĐỘC LẬP</p>
                        </div>
                        <div className="flex items-center">
                            <FontAwesomeIcon icon={faHospital} className="mr-2 w-[3vw] h-auto" />
                            <p className="ml-3 md:text-lg lg:text-2xl  font-semibold">HỆ THỐNG CƠ SỞ Y TẾ TOÀN QUỐC</p>
                        </div>
                        <div className="flex items-center">
                            <FontAwesomeIcon icon={faHandshake} className="mr-2 w-[3vw] h-auto" />
                            <p className="ml-3 md:text-lg lg:text-2xl  font-semibold">CHI PHÍ ƯU ĐÃI SO VỚI TẦM GIÁ</p>
                        </div>
                        <div className="flex items-center">
                            <FontAwesomeIcon icon={faClock} className="mr-2 w-[3vw] h-auto" />
                            <p className="ml-3 md:text-lg lg:text-2xl  font-semibold">GIẢI NGÂN NHANH CHÓNG</p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-between w-1/3">
                        <img src={images.family1} alt="" className="w-full ml-24 rounded-lg mb-2" />
                        <img src={images.family2} alt="" className="w-full mr-20 rounded-lg" />
                    </div>
                </div>
            </div>

            {/* sản phẩm của KNHCare */}
            <div className={cx('wrapper', 'mx-4')}>
                <h3 className="font-bold text-sky-600 ml-10 mb-4 text-xl md:text-4xl">
                    SẢN PHẨM ĐƯỢC KNH CARE CUNG CẤP{' '}
                </h3>
                <div className="flex justify-evenly items-center w-full">
                    <img src={images.family3} alt="" className="w-1/3 h-auto rounded-lg" />
                    <div className="w-1/2 space-y-2 lg:space-y-3">
